 ...
 * $Id$
 */
package org.simplenet.simplenet.util;
 ...
 * <!-- end-user-doc -->
 * @see org.simplenet.simplenet.SimplenetPackage
 * @generated
 */
public class SimplenetSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SimplenetPackage modelPackage;
	 ...
	 * @generated
	 */
	public SimplenetSwitch() {
		if (modelPackage == null) {
			modelPackage = SimplenetPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimplenetPackage.DEVICE: {
				Device device = (Device)theEObject;
				T result = caseDevice(device);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplenetPackage.MODULE: {
				Module module = (Module)theEObject;
				T result = caseModule(module);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplenetPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplenetPackage.NET: {
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Net</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Net</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
