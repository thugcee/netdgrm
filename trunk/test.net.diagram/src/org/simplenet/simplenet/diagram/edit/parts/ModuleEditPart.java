...
import org.simplenet.simplenet.diagram.edit.policies.ModuleItemSemanticEditPolicy;
...
public class ModuleEditPart extends ShapeNodeEditPart {
	...
	public class ModuleFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrapLabel moduleNameFigure0 = new WrapLabel();
			moduleNameFigure0.setText("<...>");

			this.add(moduleNameFigure0);
			setFigureModuleNameFigure(moduleNameFigure0);
		 ...
		 * @generated
		 */
		private WrapLabel fModuleNameFigure;

		/**
		 * @generated
		 */
		public WrapLabel getFigureModuleNameFigure() {
			return fModuleNameFigure;
		}

		/**
		 * @generated
		 */
		private void setFigureModuleNameFigure(WrapLabel fig) {
			fModuleNameFigure = fig;
		}
