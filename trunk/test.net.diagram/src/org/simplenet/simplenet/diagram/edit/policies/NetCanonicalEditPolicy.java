 ...
 * @generated
 */
public class NetCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((Net) modelObject).getDevices().iterator(); values
				.hasNext();) {
			nextValue = (EObject) values.next();
			nodeVID = SimplenetVisualIDRegistry.getNodeVisualID(viewObject,
					nextValue);
			if (DeviceEditPart.VISUAL_ID == nodeVID) {
		...
		try {
			...
			for (Iterator diagramLinks = existingLinks.iterator(); diagramLinks
				...
				EObject diagramLinkDst = nextDiagramLink.getTarget()
						.getElement();
				int diagramLinkVisualID = SimplenetVisualIDRegistry
	...
	private void collectAllLinks(View view) {
		...
		int diagramElementVisualID = SimplenetVisualIDRegistry
				.getVisualID(view);
