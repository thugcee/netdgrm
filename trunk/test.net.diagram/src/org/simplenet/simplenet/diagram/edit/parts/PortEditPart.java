...
import org.simplenet.simplenet.diagram.edit.policies.PortItemSemanticEditPolicy;
...
public class PortEditPart extends ShapeNodeEditPart {
	...
	public class PortFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrapLabel portNameFigure0 = new WrapLabel();
			portNameFigure0.setText("<...>");

			this.add(portNameFigure0);
			setFigurePortNameFigure(portNameFigure0);
		 ...
		 * @generated
		 */
		private WrapLabel fPortNameFigure;

		/**
		 * @generated
		 */
		public WrapLabel getFigurePortNameFigure() {
			return fPortNameFigure;
		}

		/**
		 * @generated
		 */
		private void setFigurePortNameFigure(WrapLabel fig) {
			fPortNameFigure = fig;
		}
