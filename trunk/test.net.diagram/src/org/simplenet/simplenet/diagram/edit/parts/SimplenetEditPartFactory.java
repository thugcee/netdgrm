 ...
 * @generated
 */
public class SimplenetEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			switch (SimplenetVisualIDRegistry.getVisualID(view)) {
			...
			case DeviceModulesCompartmentEditPart.VISUAL_ID:
				return new DeviceModulesCompartmentEditPart(view);

			case ModulePortsCompartmentEditPart.VISUAL_ID:
				return new ModulePortsCompartmentEditPart(view);
			}
		}
