...
/**
 * This is the item provider adapter for a {@link org.simplenet.simplenet.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplenetPackage.Literals.MODULE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplenetPackage.Literals.MODULE__PORTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Module.class)) {
			case SimplenetPackage.MODULE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SimplenetPackage.MODULE__PORTS:
	...
	protected void collectNewChildDescriptors(Collection<CommandParameter> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplenetPackage.Literals.MODULE__PORTS,
				 SimplenetFactory.eINSTANCE.createPort()));
	}
