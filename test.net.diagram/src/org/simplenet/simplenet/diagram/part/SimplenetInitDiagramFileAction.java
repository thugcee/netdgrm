 ...
 * @generated
 */
public class SimplenetInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SimplenetNewDiagramFileWizard(mySelectedModelFile,
				myPart.getSite().getPage(), mySelection, diagramRoot,
				editingDomain);
		IDialogSettings pluginDialogSettings = SimplenetDiagramEditorPlugin
		...
		wizard.setWindowTitle("Initialize new " + NetEditPart.MODEL_ID
				+ " diagram file");
