 ...
 * @generated
 */
public class SimplenetNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public SimplenetNewDiagramFileWizard(IFile selectedModelFile,
			IWorkbenchPage workbenchPage, IStructuredSelection selection,
			EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		assert selectedModelFile != null : "Null selectedModelFile in SimplenetNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert workbenchPage != null : "Null workbenchPage in SimplenetNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert selection != null : "Null selection in SimplenetNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert diagramRoot != null : "Null diagramRoot in SimplenetNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert editingDomain != null : "Null editingDomain in SimplenetNewDiagramFileWizard constructor"; //$NON-NLS-1$
	...
	public void addPages() {
		myFileCreationPage = new WizardNewFileCreationPage(
			...
			public void createControl(Composite parent) {
				...
				String originalFileName = mySelectedModelFile
						...
						.lastSegment();
				String fileExtension = ".simplenet_diagram"; //$NON-NLS-1$
		...
		myFileCreationPage.setDescription("Create new diagram based on "
				+ NetEditPart.MODEL_ID + " model content");
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = SimplenetVisualIDRegistry
						.getDiagramVisualID(myDiagramRoot);
				if (diagramVID != NetEditPart.VISUAL_ID) {
				...
				Diagram diagram = ViewService.createDiagram(myDiagramRoot,
						NetEditPart.MODEL_ID,
						SimplenetDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
		...
		try {
			...
			SimplenetDiagramEditorUtil.openDiagram(diagramResource);
	...
	private class RootElementSelectorPage extends WizardPage implements
		...
		private void createModelBrowser(Composite parent) {
			...
			treeViewer.setContentProvider(new AdapterFactoryContentProvider(
					SimplenetDiagramEditorPlugin.getInstance()
