 ...
 * @generated
 */
public class SimplenetMatchingStrategy implements IEditorMatchingStrategy {
	...
	public boolean matches(IEditorReference editorRef, IEditorInput input) {
		...
		if (input instanceof DiagramEditorInput
				&& editor instanceof SimplenetDiagramEditor) {
			Diagram editorDiagram = ((SimplenetDiagramEditor) editor)
					.getDiagram();
