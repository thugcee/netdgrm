 ...
 * @generated
 */
public class SimplenetCreationWizardPage extends WizardNewFileCreationPage {
	 ...
	 * @generated
	 */
	public SimplenetCreationWizardPage(String pageName,
	...
	private String getUniqueFileName(IPath containerFullPath, String fileName) {
		...
		int i = 1;
		while (SimplenetDiagramEditorUtil.exists(filePath)) {
			i++;
