...
import org.simplenet.simplenet.diagram.edit.policies.SimplenetTextSelectionEditPolicy;
...
public class ModuleNameEditPart extends CompartmentEditPart implements
	...
	protected Image getLabelIcon() {
		...
		return SimplenetElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof SimplenetTextSelectionEditPolicy) {
			((SimplenetTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return SimplenetElementTypes.Module_3001;
					}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), SimplenetEditPartFactory
