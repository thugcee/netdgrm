...
import org.simplenet.simplenet.diagram.edit.helpers.SimplenetBaseEditHelper;

/**
 * @generated
 */
public class SimplenetBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(
					SimplenetBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
