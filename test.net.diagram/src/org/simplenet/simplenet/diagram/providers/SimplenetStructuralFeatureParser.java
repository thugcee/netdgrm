 ...
 * @generated
 */
public class SimplenetStructuralFeatureParser extends SimplenetAbstractParser {
	 ...
	 * @generated
	 */
	public SimplenetStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(SimplenetDiagramEditorPlugin.ID,
